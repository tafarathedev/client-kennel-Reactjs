...
<div className="mx-4 min-h-screen max-w-screen-xl sm:mx-8 xl:mx-auto">
 <Header title="UserAccount Settings" />
  <div className="grid grid-cols-8 pt-3 sm:grid-cols-10">
    ...
    <div className="col-span-2 hidden sm:block">
      <ul>
        ...
        <li className="mt-5 cursor-pointer border-l-2 border-l-blue-700 px-2 py-2 font-semibold text-blue-700 transition hover:border-l-blue-700 hover:text-blue-700"><a href="/accounts">Accounts</a></li>
        <li className="mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 font-semibold transition hover:border-l-blue-700 hover:text-blue-700"><a href="/user">Users</a></li>
        <li className="mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 font-semibold transition hover:border-l-blue-700 hover:text-blue-700"><a href="/profile">Profile</a></li>
    ...
    <div className="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
      <div className="pt-4">
        ...
        <p className="font- text-slate-600">modify your user Account details from here</p>
      </div>
      <hr className="mt-4 mb-8" />
      <p className="py-2 text-xl font-semibold">Email Address</p>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <p className="text-gray-600">Your email address is <strong>{auth?auth().email:"example@gmail.com"}</strong></p>
